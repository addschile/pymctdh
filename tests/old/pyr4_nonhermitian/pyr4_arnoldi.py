...
def construct_sys():
    ...
    H -= 0.1*0.05j*kron(eye(2),q10a.dot(q10a),     eye(n6a),    eye(n1),     eye(n9a))
    H -= 0.1*0.05j*kron(eye(2),     eye(n10a), q6a.dot(q6a),    eye(n1),     eye(n9a))
    H -= 0.1*0.05j*kron(eye(2),     eye(n10a),     eye(n6a), q1.dot(q1),     eye(n9a))
    H -= 0.1*0.05j*kron(eye(2),     eye(n10a),     eye(n6a),    eye(n1), q9a.dot(q9a))
