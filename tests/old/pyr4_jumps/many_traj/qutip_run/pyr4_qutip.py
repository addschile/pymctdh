...
def construct_sys():
    ...
    Q10a = np.sqrt(gam)*tensor(eye(2),      q10a, eye(n6a), eye(n1), eye(n9a))
    Q6a  = np.sqrt(gam)*tensor(eye(2), eye(n10a),      q6a, eye(n1), eye(n9a))
    Q1   = np.sqrt(gam)*tensor(eye(2), eye(n10a), eye(n6a),      q1, eye(n9a))
    Q9a  = np.sqrt(gam)*tensor(eye(2), eye(n10a), eye(n6a), eye(n1),      q9a)
...
def main():
    ...
    np.savetxt('pyr4_qutip.txt', output)
