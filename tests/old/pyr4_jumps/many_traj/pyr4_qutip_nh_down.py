...
def construct_sys():
    ...
    H -= gam*0.5j*tensor(eye(2), a10a.dag()*a10a, eye(n6a), eye(n1), eye(n9a))
    H -= gam*0.5j*tensor(eye(2),       eye(n10a),  a6a.dag()*a6a, eye(n1), eye(n9a))
    H -= gam*0.5j*tensor(eye(2),       eye(n10a), eye(n6a),   a1.dag()*a1, eye(n9a))
    H -= gam*0.5j*tensor(eye(2),       eye(n10a), eye(n6a), eye(n1),  a9a.dag()*a9a)
...
def main():
    ...
    np.savetxt('pyr4_nh_qutip_down.txt', output)
