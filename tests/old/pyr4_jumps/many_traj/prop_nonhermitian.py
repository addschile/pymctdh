...
if __name__ == "__main__":
    ...
    nel    = 2
    nmodes = 4
    #nspfs = np.array([[10, 15, 9, 8],
    #                 [9, 14, 8, 7]], dtype=int)
    #npbfs = np.array([30, 50, 30, 20])

    #pbfs = list()
    #pbfs.append( PBasis(['ho', 30, 1.0, 1.0]) )
    #pbfs.append( PBasis(['ho', 50, 1.0, 1.0]) )
    #pbfs.append( PBasis(['ho', 30, 1.0, 1.0]) )
    #pbfs.append( PBasis(['ho', 20, 1.0, 1.0]) )
    ...
    #wf = vmfpropagate(times, ham, pbfs, wf, 'pyr4_nonhermitian.txt')
    wf = vmfpropagate(times, ham, pbfs, wf, 'pyr4_nonhermitian_new.txt')
