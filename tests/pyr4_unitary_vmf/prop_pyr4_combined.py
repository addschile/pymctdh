...
if __name__ == "__main__":
    ...
    pbfs.append( pymctdh.PBasis(mode1, combined=True) )
    pbfs.append( pymctdh.PBasis(mode2, combined=True) )
    ...
    results = pymctdh.Results(nsteps=len(times), db_pops=True, print_db_pops=True, db_pops_file='pyr4_combined.txt')
