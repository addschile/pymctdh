...
if __name__ == "__main__":
    ...
    results = pymctdh.Results(nsteps=len(times), db_pops=True, print_db_pops=True, db_pops_file='pyr4_ntraj_1.txt')
    pymctdh.vmfpropagatejumps(times, ham, pbfs, Ls, LdLs, wf, ntraj=1000, results=results, seed=2)
