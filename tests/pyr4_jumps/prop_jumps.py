...
from propagate import vmfpropagatejumps
...
if __name__ == "__main__":
    ...
    Ls.append( QOperator(nmodes, term, wf=wf) )
    ...
    LdLs.append( QOperator(nmodes, term, wf=wf) )
    ...
    wf = vmfpropagatejumps(times, wf, ham, Ls, LdLs, 'throwaway_jumps.dat', seed=2, nguess=1000, jump_time_tol=1.e-3)
